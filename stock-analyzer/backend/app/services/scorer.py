...
METRIC_RANGES: dict[str, tuple[float, float, bool]] = {
    ...
    "beta": (0, 2, False),
    "book_value_per_share": (0, 200, True),
    "analyst_rating": (1, 5, True),
    "trading_range_12m": (0, 100, False),
